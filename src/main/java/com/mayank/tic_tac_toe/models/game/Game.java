package com.mayank.tic_tac_toe.models.game;


import com.mayank.tic_tac_toe.exception.InvalidMoveException;
import com.mayank.tic_tac_toe.logic.GameLogic;
import com.mayank.tic_tac_toe.models.cell.CellStatus;
...
public final class Game {
    ...
    public void makeMove() throws InvalidMoveException {
        ...
        cell.Cell cellToChange = board.getBoard().get(row).get(col);
